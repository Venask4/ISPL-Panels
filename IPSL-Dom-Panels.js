/* REMOVE */
vwo_$('.main-container').css({"display":"none"});
/* CUSTOM CODE */
//
...
\
	...
	exp.init = function() {
		...
		// Add new content
		var $breadCrumbClone = $('.breadcrumbs').clone();
		$('.main-container').html(exp.vars.expHTML);
		$('.main-container').show();
		$('.AWA-breadcrumb-target').prepend($breadCrumbClone);
